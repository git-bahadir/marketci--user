...
public class VerticalRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private ArrayList<ArrayList<Shop>> mList;
    private SparseIntArray listPosition = new SparseIntArray();
    private HorizontalRecyclerAdapter.OnItemClickListener mItemClickListener;
    private Context mContext;

    public VerticalRecyclerAdapter(ArrayList<ArrayList<Shop>> list){ //indirimitemlerrecycle, shoptanıtımrecycle,bestslleritemle, kategorikategoriürün!, kategoriyegöre alışveriş,  ) {
        this.mList = list;
    }
