...
/**
 * Created by Lenovo PC on 12/12/2017.
 */
...
public class LocationUtil implements PermissionUtils.PermissionResultCallback{
    ...
    public Location getLocation() {
        ...
        //Toast.makeText(,"for fuxssake" ,Toast.LENGTH_SHORT).show();
        return null;
